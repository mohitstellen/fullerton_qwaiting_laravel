...
class StaffSettingComponent extends Component
{
    #[Title('Staff Setting')]
    ...
    public function mount()
    {
        ...
        $this->userId = $this->staffId;
        $this->record = User::find($this->staffId);
        $this->type = AccountSetting::STAFF_SLOT;
        ...
        $this->condition = [ 'team_id'=>$this->teamId ,'location_id'=>$this->locationId,'user_id'=>$this->userId,'slot_type'=> $this->type];
    ...
    public function save()
{
    ...
    AccountSetting::updateOrCreate(
        ['team_id' => $this->teamId, 'location_id' => $this->locationId,'user_id'=> $this->userId,'slot_type' =>$this->type],
...
if (empty($slot['selected_date'])) {
    ...
    {
        return view('livewire.staff-setting-component');
    }
}
