    ...
    public function loadCategories()
{
    ...
    // Join categories table to access service_time
    $query->join('categories', 'queues_storage.category_id', '=', 'categories.id');
    ...
    $this->categories = $query->select([
        ...
        // Dynamic service level period using COALESCE
