...
class  StaticSummaryCounterExport implements WithDrawings, WithEvents, ShouldAutoSize, WithTitle
{
    public $imageExcel;
    ...
    public function drawings()
    {
        ...
        $summaryChart->setPath(public_path($this->imageExcel[ 'counterHistoryChart' ])); 
