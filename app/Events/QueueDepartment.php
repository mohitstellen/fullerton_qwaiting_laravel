...
class QueueDepartment implements ShouldBroadcastNow

{
    ...
    {
        return new Channel('queue-department.'.$this->queue->team_id.'.'.$this->queue->locations_id.'.'.$this->queue->assign_staff_id);
    }
