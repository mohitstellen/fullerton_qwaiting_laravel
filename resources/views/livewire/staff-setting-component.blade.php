   <div class="p-4">
       <h3 class="text-xl font-semibold dark:text-white/90 mb-4 capitalize">{{ $record->name ?? '' }}</h3>
    @if($mainpage)
   ...
   <div class="">
      ...
      <!-- <div class="flex pb-3">
      <a href="{{ url('staff') }}" class="flex w-full justify-center rounded-lg bg-brand-500 px-4 py-2.5 text-sm font-medium text-white hover:bg-brand-600 sm:w-auto" style="margin:10px 0">
                  Back
      </a></div> -->


      <div class="flex items-start mb-4 pt-5 space-y-6 border-t border-gray-100 dark:border-gray-800 sm:pt-6" style="display:none">
         <label class="switch">
      ...
      <div class="flex justify-between items-center gap-4 mb-4" style="--cols-default: repeat(1, minmax(0, 1fr)); --cols-lg: repeat(2, minmax(0, 1fr));">
         <h3 class="text-xl font-semibold text-gray-950 dark:text-white mb-4">{{ __('setting.Staff hours') }}</h3>
         <div class="">
            <button class="--c-400:var(--primary-400);--c-500:var(--primary-500);--c-600:var(--primary-600);" class="fi-btn relative grid-flow-col items-center justify-center font-semibold outline-none transition duration-75 focus-visible:ring-2 rounded-lg fi-color-custom fi-btn-color-primary fi-color-primary fi-size-md fi-btn-size-md gap-1.5 px-3 py-2 text-sm inline-grid shadow-sm bg-custom-600 text-white hover:bg-custom-500 focus-visible:ring-custom-500/50 dark:bg-custom-500 dark:hover:bg-custom-400 dark:focus-visible:ring-custom-400/50 fi-ac-action fi-ac-btn-action" wire:click="showEditModal">
            ...
            <i class="ri-edit-line"></i> {{ __('setting.Edit hours') }}
            </span>
            </button>
         </div>
      </div>
      ...
      <div class="p-3 rounded-lg bg-white shadow dark:bg-white/[0.03] border border-gray-200 h-full col-md-6 gap-3 px-6 py-4 col-[--col-span-default] dark:bg-white/[0.03]  dark:border-gray-900">
      ...
      <div class="w-full px-2.5 xl:w-1/2 mb-3">
         <div class="p-3 rounded-lg bg-white shadow dark:bg-white/[0.03] border h-full border-gray-200 col-md-6 gap-3 px-6 py-4 col-[--col-span-default] dark:bg-white/[0.03] dark:border-gray-900">
    ...
    <div class="mt-4 space-y-4">
            ...
            @foreach($customSlots as $slotIndex => $slot)
                ...
                <div  wire:key="days-{{ $slotIndex }}">
                   <div class="mt-3 flex gap-4">
                    <input type="date" onclick="this.showPicker()" wire:model="customSlots.{{ $slotIndex }}.selected_date" class="w-full border p-2 rounded-md border-gray-400  mt-3  dark:bg-gray-800 dark:border-gray-600 dark:text-white">
                    ...
                    <div class="mt-3 flex gap-4">
                    <input type="time"  onclick="this.showPicker()" wire:model="customSlots.{{ $slotIndex }}.start_time" class="w-full border p-2 rounded-md border-gray-400  mt-3  dark:bg-gray-800 dark:border-gray-600 dark:text-white" placeholder="Start Time">
                    <input type="time"  onclick="this.showPicker()" wire:model="customSlots.{{ $slotIndex }}.end_time" class="w-full border p-2 rounded-md border-gray-400  mt-3  dark:bg-gray-800 dark:border-gray-600 dark:text-white" placeholder="End Time">
                    ...
                    <div class="mt-3 flex gap-4">
                    <input type="time"  onclick="this.showPicker()" wire:model="customSlots.{{ $slotIndex }}.day_interval.{{$Index}}.start_time" class="w-full border p-2 rounded-md border-gray-400  mt-3  dark:bg-gray-800 dark:border-gray-600 dark:text-white" placeholder="Start Time">
                    <input type="time"  onclick="this.showPicker()" wire:model="customSlots.{{ $slotIndex }}.day_interval.{{$Index}}.end_time" class="w-full border p-2 rounded-md border-gray-400  mt-3  dark:bg-gray-800 dark:border-gray-600 dark:text-white" placeholder="End Time">
                    <button type="button" wire:click="removeCustomSlot({{ $slotIndex }},{{ $Index }})" class="text-red-500">  ✖</button>
                    </div>
                    @endforeach
                    <div class="flex mt-3 gap-2">
                        <button type="button" wire:click="addCustomSlot({{ $slotIndex }})" class="--c-400:var(--primary-400);--c-500:var(--primary-500);--c-600:var(--primary-600);" class="fi-btn relative grid-flow-col items-center justify-center font-semibold outline-none transition duration-75 focus-visible:ring-2 rounded-lg fi-color-custom fi-btn-color-primary fi-color-primary fi-size-sm fi-btn-size-sm gap-1 px-2.5 py-1.5 text-sm inline-grid shadow-sm bg-custom-600 text-black hover:bg-custom-500 focus-visible:ring-custom-500/50 dark:bg-custom-500 dark:hover:bg-custom-400 dark:focus-visible:ring-custom-400/50 dark:bg-white/[0.03] dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500">+ {{ __('setting.Add Time Slot') }}</button>
                    ...
                    @endforeach
                    <div>
                    <button type="button" wire:click="addNextCustomSlot()" class="--c-400:var(--primary-400);--c-500:var(--primary-500);--c-600:var(--primary-600);" class="fi-btn relative grid-flow-col items-center justify-center font-semibold outline-none transition duration-75 focus-visible:ring-2 rounded-lg fi-color-custom fi-btn-color-primary fi-color-primary fi-size-sm fi-btn-size-sm gap-1 px-2.5 py-1.5 text-sm inline-grid shadow-sm bg-custom-600 text-black hover:bg-custom-500 focus-visible:ring-custom-500/50 dark:bg-custom-500 dark:hover:bg-custom-400 dark:focus-visible:ring-custom-400/50">+ {{ __('setting.Add Next Date Slot') }}</button>
                    </div>
                </div>
