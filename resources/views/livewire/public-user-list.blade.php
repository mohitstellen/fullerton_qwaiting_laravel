                ...
                <table class="min-w-full divide-y divide-gray-200 text-sm dark:divide-gray-700">
                    <thead class="border-b border-gray-100 dark:border-gray-200 text-gray-800 dark:text-white">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide text-white">Terms</th>
                            <th class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide text-white">Privacy</th>
                            <th class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide text-white">Marketing</th>
                    ...
                    <tbody class="divide-y divide-gray-100 bg-white dark:divide-gray-800 dark:bg-gray-900">
                        ...
                        <tr>
                            ...
                            <td class="whitespace-nowrap px-4 py-3 text-gray-700 dark:text-gray-200">
                                <span class="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium {{ $member->terms_and_conditions ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300' : 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300' }}">
                                    {{ $member->terms_and_conditions ? 'Yes' : 'No' }}
                                </span>
                            </td>
                            <td class="whitespace-nowrap px-4 py-3 text-gray-700 dark:text-gray-200">
                                <span class="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium {{ $member->consent_data_collection ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300' : 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300' }}">
                                    {{ $member->consent_data_collection ? 'Yes' : 'No' }}
                                </span>
                            </td>
                            <td class="whitespace-nowrap px-4 py-3 text-gray-700 dark:text-gray-200">
                                <span class="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium {{ $member->consent_marketing ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300' : 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300' }}">
