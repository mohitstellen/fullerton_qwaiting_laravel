                ...
                <div>
                    ...
                    <div class="flex gap-4">
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input type="radio" wire:model.live="customer_type" value="Private" class="form-radio text-blue-600 focus:ring-blue-500 h-4 w-4 border border-gray-300">
                            <span class="text-gray-700">Private Customer</span>
                        </label>
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input type="radio" wire:model.live="customer_type" value="Corporate" class="form-radio text-blue-600 focus:ring-blue-500 h-4 w-4 border border-gray-300">
                            <span class="text-gray-700">Corporate Customer</span>
                        </label>
                    </div>
                    @error('customer_type')
