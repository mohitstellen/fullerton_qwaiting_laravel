...
<html lang="en">
  ...
  <link rel="icon" href="favicon.ico"><link href="https://demo.tailadmin.com/style.css" rel="stylesheet"><script data-cfasync="false" nonce="05b94557-61f9-4458-b77d-4accf951d263">try{(function(w,d){!function(j,k,l,m){if(j.zaraz)console.error("zaraz is loaded twice");else{j[l]=j[l]||{};j[l].executed=[];j.zaraz={deferred:[],listeners:[]};j.zaraz._v="5850";j.zaraz._n="05b94557-61f9-4458-b77d-4accf951d263";j.zaraz.q=[];j.zaraz._f=function(n){return async function(){var o=Array.prototype.slice.call(arguments);j.zaraz.q.push({m:n,a:o})}};for(const p of["track","set","debug"])j.zaraz[p]=j.zaraz._f(p);j.zaraz.init=()=>{var q=k.getElementsByTagName(m)[0],r=k.createElement(m),s=k.getElementsByTagName("title")[0];s&&(j[l].t=k.getElementsByTagName("title")[0].text);j[l].x=Math.random();j[l].w=j.screen.width;j[l].h=j.screen.height;j[l].j=j.innerHeight;j[l].e=j.innerWidth;j[l].l=j.location.href;j[l].r=k.referrer;j[l].k=j.screen.colorDepth;j[l].n=k.characterSet;j[l].o=(new Date).getTimezoneOffset();if(j.dataLayer)for(const t of Object.entries(Object.entries(dataLayer).reduce(((u,v)=>({...u[1],...v[1]})),{})))zaraz.set(t[0],t[1],{scope:"page"});j[l].q=[];for(;j.zaraz.q.length;){const w=j.zaraz.q.shift();j[l].q.push(w)}r.defer=!0;for(const x of[localStorage,sessionStorage])Object.keys(x||{}).filter((z=>z.startsWith("_zaraz_"))).forEach((y=>{try{j[l]["z_"+y.slice(7)]=JSON.parse(x.getItem(y))}catch{j[l]["z_"+y.slice(7)]=x.getItem(y)}}));r.referrerPolicy="origin";r.src="/cdn-cgi/zaraz/s.js?z="+btoa(encodeURIComponent(JSON.stringify(j[l])));q.parentNode.insertBefore(r,q)};["complete","interactive"].includes(k.readyState)?zaraz.init():j.addEventListener("DOMContentLoaded",zaraz.init)}}(w,d,"zarazData","script");window.zaraz._p=async bs=>new Promise((bt=>{if(bs){bs.e&&bs.e.forEach((bu=>{try{const bv=d.querySelector("script[nonce]"),bw=bv?.nonce||bv?.getAttribute("nonce"),bx=d.createElement("script");bw&&(bx.nonce=bw);bx.innerHTML=bu;bx.onload=()=>{d.head.removeChild(bx)};d.head.appendChild(bx)}catch(by){console.error(`Error executing script: ${bu}\n`,by)}}));Promise.allSettled((bs.f||[]).map((bz=>fetch(bz[0],bz[1]))))}bt()}));zaraz._p({"e":["(function(w,d){})(window,document)"]});})(window,document)}catch(e){throw fetch("/cdn-cgi/zaraz/t"),e;};</script></head>
  <body
      ...
      >
        ...
        >
          <div>
            ...
            >
              <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="7c0e1d12181311090f190e3c0c15111613521f1311">[email&#160;protected]</a>
            </span>
          </div>
...
>
  <div class="max-w-full overflow-x-auto">
    <div class="min-w-[1102px]">
      ...
      <!-- table item -->
      <div
        class="grid grid-cols-11 border-t border-gray-100 px-5 py-4 dark:border-gray-800 sm:px-6"
      >
        <div class="col-span-3 flex items-center">
        ...
        <div class="col-span-2 flex items-center">
          <p class="text-theme-sm text-gray-500 dark:text-gray-400">3.9K</p>
        </div>
      </div>
      ...
      >
        ...
        <div class="col-span-2 flex items-center">
          <p class="text-theme-sm text-gray-500 dark:text-gray-400">24.9K</p>
        </div>
      </div>
      ...
      >
        ...
        <div class="col-span-2 flex items-center">
          <p class="text-theme-sm text-gray-500 dark:text-gray-400">12.7K</p>
        </div>
      </div>
      ...
      >
        ...
        <div class="col-span-2 flex items-center">
          <p class="text-theme-sm text-gray-500 dark:text-gray-400">2.8K</p>
        </div>
      </div>
      ...
      >
        ...
        <div class="col-span-2 flex items-center">
          <p class="text-theme-sm text-gray-500 dark:text-gray-400">Website</p>
        </div>
        <div class="col-span-2 flex items-center">
          <div class="flex -space-x-2">
            <div
        ...
        <div class="col-span-2 flex items-center">
          <p class="text-theme-sm text-gray-500 dark:text-gray-400">4,5K</p>
        </div>
      </div>
      <!-- table body end -->
    </div>
    ...
    <div class="min-w-[1102px]">
          ...
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <span class="text-theme-sm text-gray-500 dark:text-gray-400">
                <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="a4cecbcccac0c1cbe4c3c9c5cdc88ac7cbc9">[email&#160;protected]</a>
              </span>
            </div>
          </div>
        </div>
        ...
        <div class="col-span-2 flex items-center">
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <span class="text-theme-sm text-gray-500 dark:text-gray-400">
                <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="fe95979b8c8c9fbe99939f9792d09d9193">[email&#160;protected]</a>
              </span>
            </div>
          </div>
        </div>
        ...
        <div class="col-span-2 flex items-center">
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <span class="text-theme-sm text-gray-500 dark:text-gray-400">
                <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="1f7a727a6d6c70715f78727e7673317c7072">[email&#160;protected]</a>
              </span>
            </div>
          </div>
        </div>
        ...
        <div class="col-span-2 flex items-center">
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <span class="text-theme-sm text-gray-500 dark:text-gray-400">
                <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="80e3e8e1eee3e5c0e7ede1e9ecaee3efed">[email&#160;protected]</a>
              </span>
            </div>
          </div>
        </div>
      ...
      >
        ...
        <div class="col-span-2 flex items-center">
          <div class="flex items-center gap-3">
            <div
              class="flex h-10 w-10 items-center justify-center rounded-full bg-success-50"
            >
              <span class="text-xs font-semibold text-success-600"> TG </span>
            </div>
            ...
            <div>
              ...
              <span class="text-theme-sm text-gray-500 dark:text-gray-400">
                <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="64100116161d240309050d084a070b09">[email&#160;protected]</a>
              </span>
            </div>
          </div>
        </div>
  ...
  <div class="overflow-hidden">
    <div class="max-w-full px-5 overflow-x-auto sm:px-6">
      <div class="min-w-[1102px]">
        <!-- table header start -->
        <div
          class="grid grid-cols-11 py-3 border-t border-gray-100 dark:border-gray-800"
        >
          <div class="flex items-center col-span-3">
            <p class="text-gray-500 text-theme-sm dark:text-gray-400">Name</p>
          </div>
          <div class="flex items-center col-span-2">
            <p class="text-gray-500 text-theme-sm dark:text-gray-400">Date</p>
          </div>
          <div class="flex items-center col-span-2">
            <p class="text-gray-500 text-theme-sm dark:text-gray-400">Price</p>
          </div>
          <div class="flex items-center col-span-2">
        ...
        <!-- table item -->
        <div
          class="grid grid-cols-11 py-4 border-t border-gray-100 dark:border-gray-800"
        >
          <div class="flex items-center col-span-3">
            <div class="flex items-center gap-3">
              <div class="w-8 h-8">
          ...
          <div class="flex items-center justify-center col-span-1">
            <div x-data="{openDropDown: false}" class="relative">
              ...
              <div
                x-show="openDropDown"
                @click.outside="openDropDown = false"
                class="absolute right-0 z-40 w-40 p-2 space-y-1 bg-white border border-gray-200 bottom-full rounded-2xl shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark"
              >
                <button
                  class="flex w-full px-3 py-2 font-medium text-left text-gray-500 rounded-lg text-theme-xs hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
                >
    ...
    <div class="flex items-center justify-between">
      ...
      <ul class="hidden items-center gap-0.5 sm:flex">
        <li>
          <a
            href="#"
            class="flex h-10 w-10 items-center justify-center rounded-lg bg-brand-500/[0.08] text-theme-sm font-medium text-brand-500 hover:bg-brand-500/[0.08] hover:text-brand-500 dark:text-brand-500 dark:hover:text-brand-500"
          >
            1
          </a>
        </li>
        ...
        <li>
          <a
            href="#"
            class="flex h-10 w-10 items-center justify-center rounded-lg text-theme-sm font-medium text-gray-700 hover:bg-brand-500/[0.08] hover:text-brand-500 dark:text-gray-400 dark:hover:text-brand-500"
          >
            2
          </a>
        </li>
    ...
    <div class="min-w-[617px] 2xl:min-w-[808px]">
      ...
      >
        <div class="col-span-4 flex items-center">
          <p class="text-theme-sm text-gray-500 dark:text-gray-400">Creator</p>
        </div>
        <div class="col-span-4 flex items-center">
          <p class="text-theme-sm text-gray-500 dark:text-gray-400">Campaing</p>
        </div>
        <div class="col-span-2 flex items-center">
...
>
  ...
  <div class="max-w-full overflow-x-auto">
    <div class="min-w-[617px] 2xl:min-w-[808px]">
      <!-- table header start -->
      <div
        class="grid grid-cols-12 border-t border-gray-100 px-6 py-3 dark:border-gray-800"
      >
        <div class="col-span-3 flex items-center">
          <p class="text-theme-xs font-medium text-gray-500 dark:text-gray-400">
            Products
      ...
      <!-- table item -->
      <div
        class="grid grid-cols-12 border-t border-gray-100 px-6 py-3.5 dark:border-gray-800"
      >
        <div class="col-span-3 flex items-center">
        ...
        <div class="col-span-3 flex items-center">
          <p class="text-theme-sm text-gray-500 dark:text-gray-400">UI Kit</p>
        </div>
        <div class="col-span-2 flex items-center">
      ...
      >
        ...
        <div class="col-span-3 flex items-center">
          <p class="text-theme-sm text-gray-500 dark:text-gray-400">SaaS</p>
        </div>
        <div class="col-span-2 flex items-center">
          <div class="h-5 w-5 overflow-hidden rounded-full">
...
<!-- ====== Table Two End -->
    ...
    <!-- ===== Page Wrapper End ===== -->
  <script data-cfasync="false" src="https://demo.tailadmin.com/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script defer src="bundle.js"></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"917d653fedaeb954","version":"2025.1.0","r":1,"token":"67f7a278e3374824ae6dd92295d38f77","serverTiming":{"name":{"cfExtPri":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}}}' crossorigin="anonymous"></script>
</body>
</html>
