                ...
                <div class="flex flex-col md:justify-center flex-1 w-full max-w-md mx-auto">
                    <div class="p-6">
                        <div class="mb-5 sm:mb-8">
                            ...
                            @endif
                            <h1
                                class="mb-2 font-semibold text-gray-800 text-xl dark:text-white/90  md:text-left text-center">
                                Login for Qwaiting
                            </h1>
                        ...
                        <div>
                            ...
                            @if ($errors->any())
                                <div class="mb-4 p-3 text-sm text-red-800 bg-red-100 border border-red-300 rounded-lg">
                                    <ul>
                                        ...
                                        <div class="relative">
                                            ...
                                            <button type="button" onclick="togglePassword()"
                                                ...
                                                <span id="eyeIcon" class="absolute right-1 z-30  cursor-pointer">
                                                    <!-- Eye Open Icon -->
                                                    <svg id="eyeOpen" class="fill-gray-500 dark:fill-gray-400" width="20"
                                                    ...
                                                    <!-- Eye Closed Icon -->
                                                    <svg id="eyeClosed" class="fill-gray-500 dark:fill-gray-400 hidden"
                                            ...
                                            <label for="checkboxLabelOne"
                                                ...
                                                <div class="relative">
                                                    <input type="checkbox" id="checkboxLabelOne" class="sr-only"
                                                        name="remember" @change="checkboxToggle = !checkboxToggle" />
                                                    <label for="checkboxLabelOne"
                            ...
                            @if(isset($addon) && $addon->office_enabled == 1)
                                <div class="mt-5">
                                    ...
                                    <a href="{{ url('office365/login') }}"><button type="submit"
                                            class="flex items-center justify-center w-full px-4 py-3 text-sm font-medium text-white transition rounded-lg  shadow-theme-xs bg-brand-500 hover:bg-brand-600">Login
                                            With Office 365</button> </a>
