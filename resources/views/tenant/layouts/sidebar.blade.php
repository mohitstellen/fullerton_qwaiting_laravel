    ...
    <nav x-data="{selected: $persist('Dashboard')}">
      ...
      <div>
        ...
        <ul class="flex flex-col gap-4 mb-6">
          ...
          <li>
            <a
              href="{{ route('tenant.companies.index') }}"
              @click.prevent="selected = (selected === 'Companies' ? '':'Companies')"
              class="menu-item group"
              :class=" (selected === 'Companies') || (page === 'companies') ? 'menu-item-active' : 'menu-item-inactive'"
              wire:navigate>
              <svg
                :class="(selected === 'Companies') || (page === 'companies') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'"
                width="24"
                height="24"
                viewBox="0 0 24 24"
                fill="none"
