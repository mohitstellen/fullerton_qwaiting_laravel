...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('orders', function (Blueprint $table) {
            // Remove JSON field
            $table->dropColumn('appointments_data');
    ...
    public function down(): void
    {
        Schema::table('orders', function (Blueprint $table) {
            ...
            // Remove columns
            $table->dropColumn([
                'booking_id', 'refID', 'service_name', 'appointment_type', 'appointment_type_id',
                'package', 'package_id', 'location', 'location_id', 'booking_date', 'booking_time',
                'start_time', 'end_time', 'booking_date_time', 'name', 'email', 'phone', 'phone_code',
                'date_of_birth', 'gender', 'nationality', 'identification_type', 'additional_comments',
                'booking_for', 'nric_fin', 'passport', 'appointment_status'
            ]);
            
            // Restore JSON field
            $table->json('appointments_data')->nullable()->after('notes');
        });
    }
};
